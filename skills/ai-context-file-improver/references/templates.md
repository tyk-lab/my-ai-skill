...
Describe the project structure so the AI assistant understands where things live.
...
List important files that the AI assistant should know about.
...
When updating any AI context file (for example, `AGENTS.md`, `CLAUDE.md`, or `.cursorrules`):
...
4. **Be useful**: Would this help the AI assistant understand the project in a new session?
